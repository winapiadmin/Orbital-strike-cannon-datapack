...
execute if score craft_toggle_ craft_toggle_ matches 1 run give @s fishing_rod[damage=63,custom_data={stab_3:1b},minecraft:custom_name=[{"text":"STAB POWER 3","italic":false}]]
